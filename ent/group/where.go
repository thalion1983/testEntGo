...
// HasPeoples applies the HasEdge predicate on the "peoples" edge.
func HasPeoples() predicate.Group {
...
// HasPeoplesWith applies the HasEdge predicate on the "peoples" edge with a given conditions (other predicates).
func HasPeoplesWith(preds ...predicate.People) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := newPeoplesStep()
